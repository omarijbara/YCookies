...
$backupConnection = env('DB_CONNECTION', 'mysql');
$shouldDisableDumpCompression =
...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Intentionally empty — code is in Git, only DB backups are needed.
                    // The schedule uses `backup:run --only-db`.
                ],
         ...
         */
        // SQLite dumps in tests/local Windows use an external subprocess. Keeping the
        // dump uncompressed avoids depending on a system gzip binary that may not exist.
        'database_dump_compressor' => $shouldDisableDumpCompression
            ? null
            : \Spatie\DbDumper\Compressors\GzipCompressor::class,
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'revyome@ypsilon.dev'),
