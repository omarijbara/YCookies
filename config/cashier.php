...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Cashier Plans (Filament Billing Provider)
    |--------------------------------------------------------------------------
    */
    'plans' => [
        // The 'default' plan is what BillingProvider('default') resolves.
        // This is the entry-level subscription new tenants are redirected to.
        'default' => [
            'price_id' => env('STRIPE_PRICE_PRO_MONTHLY', 'price_1T9PuUCqOt3Mipp1ZzEvHkJG'),
        ],
        'pro_monthly' => [
            'price_id' => env('STRIPE_PRICE_PRO_MONTHLY', 'price_1T9PuUCqOt3Mipp1ZzEvHkJG'),
            'type' => 'default',
        ...
        'agency_monthly' => [
            'price_id' => env('STRIPE_PRICE_AGENCY_MONTHLY', 'price_1T9PudCqOt3Mipp1bJUzv0EC'),
            'type' => 'default',
        ],
        'enterprise' => [
            'price_id' => env('STRIPE_PRICE_ENTERPRISE', 'price_1T9PueCqOt3Mipp1qjPMUx7i'),
            'type' => 'default',
        ],
    ],
